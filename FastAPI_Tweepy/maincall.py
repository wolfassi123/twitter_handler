from refactor import client
from refactor import configuration
# from refactor.User import user

con = configuration.Configuration(
    api_key="p95pQNjiYzjtRTBCTcw9ILgEt",
    api_key_secret="fws75G2w8LAaM9MzpHZurgbXNMuj2e6FTO1dFe3xhHh84OtNZ6",
    access_token="1271325853373173760-na24sToFiTZSAIFeJrscsrxDW9VB03",
    access_token_secret="ZYfLTGXmyxK1az3SDNDytuauSRoCxYLAyQyoMTCCZCoV2",
    bearer_token="AAAAAAAAAAAAAAAAAAAAAMntbgEAAAAAawa8f6GoO1zHNRGboG5UUglG4FE%3DvBXGltiij6OSkC82YTyuuoSdczHj299sRIQyvOnHwJhmJLHJCv",
)
